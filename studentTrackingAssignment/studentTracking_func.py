...
def first_run(self):
    ...
    with conn:
        ...
        if count < 1:
            cur.execute("""INSERT INTO tbl_students (col_fname,col_lname,col_fullname,col_phone,col_email,col_course) VALUES (?,?,?,?,?,?)""", ('Daniel','Alvarez','Daniel Alvarez','864-607-1607','dannymalvarez@gmail.com','Software Deveopment'))
            conn.commit()
    conn.close()
